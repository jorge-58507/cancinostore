...
class CreateCsProductcategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cs_productcategories', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cs_productcategories');
    }
}
